...
library(qtl2)
chr <- c(1:19, "X")
write_control_file("Data/svenson.json",
                   crosstype="do",
                   description="Svenson DO project see http://churchill.jax.org/research/cc/do_data/megamuga/raw/183_Svenson_DO/",
...
ids <- colnames(read.table("Data/svenson_geno19.csv", comment.char="#",
...
write.table(covar, "Data/svenson_covar.csv", sep=",",
