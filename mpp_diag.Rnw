...
genotype data from Diversity Outbred (DO) mice, illustrated with
genotype data from the MegaMUGA array on a set of 291 DO mice.
...
SNP markers have incomplete information since they generally have only
two alleles.
